...
!function(a) {
    ...
    jQuery.extend(!0, b, {
        checkForParallax: function(a, e) {
            function g(a) {
                if ("3D" == f.type || "3d" == f.type) {
                    ...
                    d.appendTo(b),
                    "carousel" == e.sliderType && ("on" == f.ddd_shadow && b.addClass("dddwrappershadow"),
            ...
            if (!f.done) {
                ...
                "carousel" != e.sliderType && "on" == f.ddd_shadow && (e.c.prepend('<div class="dddwrappershadow"></div>'),
                ...
                e.c.find(".tp-revslider-slidesli .slotholder, .tp-revslider-slidesli .rs-background-video-layer").each(function() {
                    ...
                    b = "on" == b ? 1 : b,
                    void 0 !== b && "off" !== b && (f.bgcontainers.push(a),
                    f.bgcontainer_depths.push(e.parallax.levels[parseInt(b, 0) - 1] / 100))
                });
                ...
                a.on("mousemove.hoverdir, mouseleave.hoverdir, trigger3dpath", function(b, c) {
                    ...
                    if ("enterpoint" == f.origo) {
                        ...
                        var g = a.offset().top
                          ...
                          , m = f.speed / 1e3 || 3;
                    "mouseleave" == b.type && (k = f.ddd_lasth || 0,
                    l = f.ddd_lastv || 0,
                    m = 1.5);
                    ...
                    if ("3D" == f.type || "3d" == f.type) {
                        ...
                        e.c.find(t).each(function() {
                            var a = jQuery(this)
                              ...
                              , n = 0
                              , o = !1;
                            a.hasClass("dddwrapper-layer") && (n = f.ddd_z_correction || 65,
                            o = !0),
                            a.hasClass("dddwrapper-layer") && (d = 0,
                            g = 0),
                            j.hasClass("active-revslide") || "carousel" != e.sliderType ? "on" != f.ddd_bgfreeze || o ? punchgs.TweenLite.to(a, m, {
                                rotationX: i,
                                rotationY: -h,
                                x: d,
                                z: n,
        ...
        scrollTicker: function(a, d) {
            1 != a.scrollTicker && (a.scrollTicker = !0,
            c ? (punchgs.TweenLite.ticker.fps(150),
        ...
        scrollHandling: function(a, d) {
            if (a.lastwindowheight = a.lastwindowheight || window.innerHeight,
            ...
            g.enable) {
                ...
                1 - g.visible_area <= j ? a.inviewport || (a.inviewport = !0,
                b.enterInViewPort(a)) : a.inviewport && (a.inviewport = !1,
                b.leaveViewPort(a))
            }
            if (c && "on" == h.disable_onmobile)
                return !1;
            ...
            if (q.on && ("on" !== q.disable_on_mobile || !c)) {
                ...
                q.layers !== !1) {
                    ...
                    if ("on" === q.grayscale) {
                        var v = 100 * (1 - s)
                          , w = "grayscale(" + v + "%)";
                        t["-webkit-filter"] = void 0 === t["-webkit-filter"] ? w : t["-webkit-filter"] + " " + w,
