...
!function(a) {
    ...
    var d = function(a, c, d, e) {
        ...
        void 0 != g.data("curscale") && "box" == e ? i = 100 * g.data("curscale") : void 0 != g.data("curscale") && (i = g.data("curscale")),
        b.slotSize(g, c);
        var k = g.attr("src")
        ...
        case "horizontal":
            if ("horizontal" == e) {
                ...
                for (var x = 0; x < c.slots + 2; x++)
                    f.append('<div class="slot" style="position:absolute;top:' + (p + x * c.sloth) + "px;left:" + o + "px;overflow:hidden;width:" + m + "px;height:" + c.sloth + 'px"><div class="slotslide ' + h + '" style="position:absolute;top:' + q + "px;left:0px;width:" + m + "px;height:" + c.sloth + 'px;overflow:hidden;"><div style="background-color:' + l + ";position:absolute;top:" + (0 - x * c.sloth) + "px;left:0px;width:" + m + "px;height:" + n + "px;background-image:url(" + k + ");background-repeat:" + s + ";background-size:" + r + ";background-position:" + t + ';"></div></div></div>'),
                    void 0 != i && void 0 != j && punchgs.TweenLite.set(f.find(".slot").last(), {
                        rotationZ: j
                    })
            }
      ...
      , e = function(a, b, c, d) {
        ...
        "random" == b && (b = Math.round(Math.random() * v.length - 1),
        b > v.length - 1 && (b = v.length - 1)),
        "random-static" == b && (b = Math.round(Math.random() * o.length - 1),
        b > o.length - 1 && (b = o.length - 1),
        b = o[b]),
        "random-premium" == b && (b = Math.round(Math.random() * p.length - 1),
      ...
      , g = function(a, b, c, g, h, i, j, k) {
        function V(a, b, c, d, e) {
            ...
            a.find(".slot-circle-wrapper").each(function(a) {
                if (a < g) {
                    ...
                    k.add(punchgs.TweenLite.fromTo(d, .001, {
                        autoAlpha: 0
                    }, {
                        autoAlpha: 1
                    }), 0)
        ...
        k.add(punchgs.TweenLite.set(i.parent(), {
        ...
        if (u = "default" === u ? q[9] || punchgs.Power2.easeInOut : u || q[9] || punchgs.Power2.easeInOut,
        v = "default" === v ? q[10] || punchgs.Power2.easeInOut : v || q[10] || punchgs.Power2.easeInOut,
        0 == a) {
        ...
        if (4 == a || 5 == a) {
            ...
            i.find(".slotslide").each(function(b) {
                var c = jQuery(this)
                  , d = b * B / l.slots;
                5 == a && (d = (l.slots - b - 1) * B / l.slots / 1.5),
                A.add(punchgs.TweenLite.from(c, 3 * B, {
                    top: 0 - l.height,
                    opacity: .5,
                    rotation: l.rotate,
                    force3D: "auto",
        ...
        if (9 == a || 10 == a) {
            ...
            i.find(".slotslide").each(function(a) {
                var b = jQuery(this);
                D++,
                k.add(punchgs.TweenLite.fromTo(b, t / 2e3, {
                    autoAlpha: 0,
                    force3D: "auto",
                    transformPerspective: 600
                }, {
        ...
        if (31 == a || 32 == a || 33 == a || 34 == a) {
            ...
            k.add(punchgs.TweenLite.fromTo(i, U, {
                y: fy,
                x: fx
            }, {
                y: "0%",
        ...
        if (11 == a) {
            ...
            case 1:
                ...
                k.add(punchgs.TweenLite.fromTo(j, t / 1e3, {
                    autoAlpha: 1
                }, {
                    autoAlpha: 0,
                    force3D: "auto",
            ...
            case 4:
                ...
                k.add(punchgs.TweenLite.to(j, t / 2e3, {
                    autoAlpha: 0,
                    force3D: "auto",
                    ease: u
                }), 0),
                k.add(punchgs.TweenLite.fromTo(i, t / 2e3, {
                    autoAlpha: 0
                }, {
                    autoAlpha: 1,
                    force3D: "auto",
            ...
            k.add(punchgs.TweenLite.set(j.find("defaultimg"), {
                autoAlpha: 1
            }), 0)
        }
        if (26 == a) {
            ...
            k.add(punchgs.TweenLite.to(j, t / 1e3, {
                autoAlpha: 0,
                force3D: "auto",
                ease: u
            }), 0),
        ...
        if (12 == a || 13 == a || 14 == a || 15 == a) {
            ...
            var X = l.width
              ...
              , da = t / 1e3
              , ea = da;
            "fullwidth" != l.sliderLayout && "fullscreen" != l.sliderLayout || (X = Z.width(),
            Y = Z.height()),
            ...
            k.add(punchgs.TweenLite.set(g, {
                zIndex: 20
            }), 0),
            8 == r ? (k.add(punchgs.TweenLite.set(h, {
                zIndex: 20
            }), 0),
            k.add(punchgs.TweenLite.set(g, {
                zIndex: 15
            }), 0),
            k.add(punchgs.TweenLite.set(ga, {
                left: 0,
                top: 0,
                scale: 1,
                opacity: 1,
        ...
        if (16 == a) {
            ...
            k.add(punchgs.TweenLite.set(h.find(".tp-half-two"), {
                width: X,
                height: Y,
                overflow: "hidden",
                zIndex: 15,
            ...
            k.add(punchgs.TweenLite.fromTo(h.find(".tp-half-one"), t / 800, {
                width: X,
                height: Y / 2,
                position: "absolute",
                top: "0px",
            ...
            k.add(punchgs.TweenLite.fromTo(h.find(".tp-half-two"), t / 800, {
                width: X,
                height: Y,
                overflow: "hidden",
                position: "absolute",
                ...
                onComplete: function() {
                    ...
                    h.find(".tp-half-one").length > 0 && (h.find(".tp-half-one .defaultimg").unwrap(),
                    h.find(".tp-half-one .slotholder").unwrap()),
                    h.find(".tp-half-two").remove()
                }
            }), 0),
            A.add(punchgs.TweenLite.set(i.find(".defaultimg"), {
                autoAlpha: 1
            }), 0),
            null != h.html() && k.add(punchgs.TweenLite.fromTo(g, (t - 200) / 1e3, {
                scale: qa,
                x: l.width / 4 * ma,
                y: Y / 4 * na,
                rotation: la,
        ...
        19 == a || 22 == a) {
            ...
            i.find(".slotslide").each(function(a) {
                ...
                A.add(punchgs.TweenLite.to(b, .1, {
                    autoAlpha: 1,
                    delay: 50 * a / 1e3
                }), 0),
                k.add(A)
        ...
        if (21 == a || 25 == a) {
            ...
            1 != o ? (ta = -l.width,
            ra = 90,
            25 == a ? (sa = "center top 0",
            ua = -ra,
            ra = l.rotate) : (sa = "left center 0",
            ua = l.rotate)) : (ta = l.width,
            ra = -90,
            25 == a ? (sa = "center bottom 0",
            ua = -ra,
            ra = l.rotate) : (sa = "right center 0",
            ua = l.rotate)),
            j.find(".slotslide").each(function(a) {
                var b = jQuery(this);
                k.add(punchgs.TweenLite.fromTo(b, t / 1e3, {
        ...
        if (23 == a || 24 == a) {
            ...
            j.find(".slotslide").each(function(b) {
                ...
                23 == a && k.add(punchgs.TweenLite.fromTo(c, t / 2e3, {
                    autoAlpha: 1
                }, {
                    autoAlpha: 0,
