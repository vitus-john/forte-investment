...
!function($) {
    ...
    function getScrollRoot() {
        var d, a = document.documentElement, b = document.body, c = ("undefined" != typeof window.pageYOffset ? window.pageYOffset : null) || b.scrollTop || a.scrollTop;
        return a.scrollTop = b.scrollTop = c + (c > 0) ? -1 : 1,
        d = a.scrollTop !== c ? a : b,
        d.scrollTop = c,
        d
    }
    ...
    var checkActions_intern = function(a, b, c) {
            ...
            switch (a.on(d.event, function() {
                ...
                if ("stoplayer" == d.action || "togglelayer" == d.action || "startlayer" == d.action) {
                    if (c.length > 0) {
                        ...
                        _R.playAnimationFrame && (clearTimeout(e.triggerdelayIn),
                        ...
                        _R.endMoveCaption && (clearTimeout(e.triggerdelayOut),
      ...
      , actionSwitches = function(tnc, opt, a, _nc) {
        ...
        case "scrollbelow":
            ...
            off = off - aof || 0,
            opt.scrollRoot = void 0 === opt.scrollRoot ? getScrollRoot() : opt.scrollRoot;
            var sobj = {
