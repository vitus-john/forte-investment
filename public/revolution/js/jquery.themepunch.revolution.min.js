        ...
        !a.hasClass("revslider-initialised")) {
            ...
            a.find(".tp-caption, .rs-background-video-layer").each(function(a) {
                ...
                c.hasClass("tp-caption")) {
                    ...
                    c.wrap("<div " + t + ' class="tp-parallax-wrap ' + r + '" style="' + m + "position:" + q + ";" + s + ';visibility:hidden"><div class="tp-loop-wrap" style="' + m + "position:" + q + ";" + s + ';"><div class="tp-mask-wrap" style="' + m + "position:" + q + ";" + s + ';" ></div></div></div>'),
